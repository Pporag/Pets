    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      // if the intent DOES NOT contain a  pet URI, then we know that we are creating a new pet
        if (mCurrentPetUri == null){
            // This is a new pet so change the App Bar to say "Add anew pet"
            setTitle(getString(R.string.app_bar_tile_add));
            }
            else {

            setTitle(getString(R.string.app_bar_tile_edit));
